...
public class CompanyRestControllerImpl implements CompanyRestController {
    ...
    public ResponseEntity<String> createCompany(@RequestBody String companyName) {
        companyService.createCompany(new Company(0l, companyName));
    ...
    @Override
    @ApiOperation(value = "Update company from an Id", response = CompanyDTO.class)
    ...
    @Override
    @ApiOperation(value = "List all companies", response = CompanyDTO.class, responseContainer = "List")
    ...
    public ResponseEntity<CompanyDTO> getCompany(
            @ApiParam(value = "Page to fetch", required = true) @PathVariable long id) {
    ...
    @ApiOperation(value = "Get all computers from a given company", response = ComputerDTO.class, responseContainer = "List")
